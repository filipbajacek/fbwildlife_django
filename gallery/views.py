...
def en_about_license(request):
    return render(request, 'EN/Info_about_license.html')
...
def sk_about_license(request):
    return render(request, 'SK/Info_about_license.html')
