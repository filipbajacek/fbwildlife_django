...
urlpatterns = [
    ...
    path("EN/Info_about_license.html", views.en_about_license, name="en_about_license"),
    ...
    path("SK/Info_about_license.html", views.sk_about_license, name="sk_about_license"),
